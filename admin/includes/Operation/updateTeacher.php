<div class="modal fade" id="edit_teacher" tabindex="-1" aria-labelledby="teachModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content b-grey">
            <div class="modal-body">
                ...
                <form action="?page=teacher" method="POST" class="row g-2 needs-validation" novalidate>
                    <div class="col-md-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group input-group has-validation">
                            ...
                            <input type="text" class="form-control" name="contact" aria-describedby="inputGroupPrepend" pattern="9\d{9}" required>
                    ...
                    <div class="col-6">
                        <button name="submit" class="btn btn-primary w-100 mt-3 mb-2" type="submit"><i class="bi bi-pencil-fill me-2"></i>Update</button>
                    </div>
                    <div class="col-6">
