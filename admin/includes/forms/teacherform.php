...
<div class="modal fade" id="teacher" tabindex="-1" aria-labelledby="strandModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content b-grey">
            <div class="modal-body">
                <form id="teacherForm" action="./includes/teacher-inc.php" method="POST" class="row g-2 needs-validation" novalidate>
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-select" name="role" id="usertype" required onchange="toggleForm()">
