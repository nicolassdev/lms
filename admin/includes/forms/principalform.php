...
<div class="modal fade" id="principal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content b-grey">
            <div class="modal-body">
                <form id="principalForm" action="./includes/principal-inc.php" method="POST" enctype="multipart/form-data" autocomplete="off" class="row g-2 needs-validation " novalidate>
                    ...
                    <input type="text" class="form-control d-none" name="role" value="PRINCIPAL" required>
...
<script>
    ...
    function resetFormTeacher() {
        ...
        principalForm.classList.remove('was-validated');
