...
if (!isset($_POST["submit"])) {
    ...
    try {
            ...
            $principalColumns = ['firstname', 'middlename', 'lastname', 'contact', 'gender', 'email', 'address', 'id'];
            $principalValues = [$fname, isset($_POST["middlename"]) ? strtoupper(trim($_POST["middlename"])) : null, $lname, $contact, $gender, $email, $address,  $uid];
