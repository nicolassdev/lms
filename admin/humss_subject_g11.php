 ...
 <?php
    ...
    if (!empty($result)) {
        foreach ($result as $row) {
            $strandsToSkip = ['ABM', 'STEM', 'GAS', 'CS', 'CSS'];

            // Skip rows with specified strands
            if (in_array(strtoupper($row["strand"]), $strandsToSkip)) {
             ...
             <div class="col-12">
                 <div class="data-table">
                     ...
                     <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-3  ms-3 me-3">
                         <h6 class="text-muted"><?php echo ucwords(strtolower($row['strand_desc'])); ?>
                             <div class="mt-2">
                                 <?php
                             ...
                             <?php
                                ...
                                foreach ($result as $row) {
                                    ...
                                    if (!empty($row['sub_gradelvl'])) {
                                        ...
                                        if (strtoupper($row['sub_gradelvl']) == 'GRADE-11' && !$gradeDisplayed) {
                             ...
                             <tbody>
                                 <?php
                                    ...
                                    if (!empty($result)) {
                                        $count = 0;
                                        foreach ($result as $row) {
                                            if (strtoupper($row["sub_gradelvl"]) == 'GRADE-11' && strtoupper($row["strand"]) == 'HUMSS') {
                                                echo '<tr>';
