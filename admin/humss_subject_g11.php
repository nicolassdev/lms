             ...
             <div class="col-12">
                 <div class="data-table">
                     ...
                     <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-3  ms-3 me-3">
                         <h6 class="text-muted fw-bold"><?php
                                                        if (!empty($result)) {
                             ...
                             <?php
                                ...
                                foreach ($result as $row) {
                                    ...
                                    if (!empty($row['grade_lvl'])) {
                                        ...
                                        if (strtoupper($row['grade_lvl']) == 'GRADE-11' && !$gradeDisplayed) {
                     ...
                     <div class="table-responsive small ms-3 me-3">
                         <table id="humssSubject" class="table table-bordered table-striped table-sm align-middle ">
                             ...
                             <tbody>
                                 <?php
                                    ...
                                    if (!empty($result)) {
                                        $count = 0;
                                        foreach ($result as $row) {
                                            if (strtoupper($row["grade_lvl"]) == 'GRADE-11' && strtoupper($row["strand_name"]) == 'HUMSS') {
                                                echo '<tr>';
...
<script>
    initializeDataTable("humssSubject", 5, "HUMSS Grade-11 | Subject List");
</script>