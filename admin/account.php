                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 col-12 text-center">
                            <div class="profile-header" style="margin-top: 60px;">
                                ...
                                if (!empty($registrarlInfo['image']) && file_exists($uploadDir . $registrarlInfo['image'])) {
                                ?>
                                    <img src="<?php echo htmlspecialchars($uploadDir . $registrarlInfo['image']); ?>" alt="Profile Image" draggable="false" class="profile-img-circle mb-2">
                                    <?php
                                } else {
                                    // Fallback to the default image based on gender
                                    if ($registrarlInfo['gender'] === "MALE") {
                                    ?>
                                ...
                                <h5><?php echo ucwords(strtolower($registrarFullName)); ?>
                        ...
                        <div class="col-md-6 col-12">
                            <form action="./includes/Operation/updateAccount.php" method="POST" class="needs-validation" novalidate>
                                ...
                                <input type="hidden" class="form-control" name="adminid" value="<?php echo $account['id']; ?>" required>
