                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 col-12 text-center">
                            <div class="profile-header" style="margin-top: 60px;">
                                ...
                                <?php if (!empty($registrarlInfo['image'])) { ?>
                                    <img src="../assets/Upload/<?php echo htmlspecialchars($registrarlInfo['image']); ?>" alt="Profile Image" draggable="false" class="profile-img-circle mb-2">
                                <?php } else { ?>
