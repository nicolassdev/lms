        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card shadow-lg border-0 h-100 rounded-4">
                    <div class="card-body text-center d-flex flex-column p-4">
                        ...
                        <h5 class="fw-bold text-dark">GRADE-11 | ABM</h5>
                        <p class="text-muted small mb-3">View subjects of grade 11 abm.</p>
                        <p class="fs-4 text-danger fw-bold mb-4">

                        </p>
                        <a href="?page=abm_subject_g11" class="btn btn-outline-danger mt-auto rounded-pill fw-semibold">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card shadow-lg border-0 h-100 rounded-4">
                    <div class="card-body text-center d-flex flex-column p-4">
                        <span class="bi bi-journals text-danger display-5 mb-3"></span>
                        <h5 class="fw-bold text-dark">GRADE-12 | ABM</h5>
                        <p class="text-muted small mb-3">View subjects of grade 12 abm.</p>
                        <p class="fs-4 text-danger fw-bold mb-4">

                        </p>
                        <a href="?page=abm_subject_g12" class="btn btn-outline-danger mt-auto rounded-pill fw-semibold">
                            <i class="bi bi-person-rolodex me-1"></i>Subjects
                        </a>
                    </div>
                </div>
