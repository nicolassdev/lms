             ...
             <div class="col-12">
                 <div class="data-table">
                     ...
                     <div class="table-responsive small ms-3 me-3">
                         <table id="cssSubject" class="table table-bordered table-striped table-sm align-middle ">
                             ...
                             <tbody>
                                 <?php
                                    ...
                                    if (!empty($result)) {
                                        $count = 0;
                                        foreach ($result as $row) {
                                            if (strtoupper($row["grade_lvl"]) == 'GRADE-12' && strtoupper($row["strand_name"]) == 'CSS') {
                                                echo '<tr>';
 ...
 <script>
     initializeDataTable("cssSubject", 5, "CSS Grade-12 | Subject List");
 </script>