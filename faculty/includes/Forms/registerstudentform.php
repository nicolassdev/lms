    ...
    <div class="modal-dialog modal-lg ">
        <div class="modal-content b-grey">
            <div class="modal-body">
                ...
                <form id="enrollForm" action="./includes/registerstudent-inc.php" method="POST" autocomplete="off" class="row g-2 needs-validation" novalidate>
                    ...
                    <div class="modal-header">
                        <div class="fs-5">Registration Form
                            <?php
