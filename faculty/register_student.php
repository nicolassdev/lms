...
include "../faculty/includes/Forms/registerstudentform.php";
                                                ...
                                                <div class="modal-dialog modal-md">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body p-4">
                                                            <form action="./includes/Operation/updateRegisterStudent.php" method="POST" class="row g-3 needs-validation" novalidate id="editEnrollForm' . htmlspecialchars($row['stu_lrn']) . '"> 
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <div class="modal-content shadow-lg">
                                                    ...
                                                    <div class="modal-footer justify-content-center border-0 mt-3 mb-4">
                                                        <a href="includes/Operation/deleteRegisterStudent.php?id=' . urlencode($row['stu_lrn']) . '" class="btn btn-danger px-4 py-2 me-3" style="width: 120px;">Remove</a>
